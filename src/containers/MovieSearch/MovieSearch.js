...
class MovieSearch extends Component {
    state = {
        movieId: 'tt3387520', // default imdb id
        title: '',
        movie: {},
        searchResults: [],
        isSearching: false,
    ...
    loadMovie() {
        axios.get(`http://www.omdbapi.com/?apikey=309a5f87&i=${this.state.movieId}`)
            .then(response => {
    ...
    searchMovie = (event) => {
        ...
        this.timeout = setTimeout(() => {
            axios.get(`http://www.omdbapi.com/?apikey=309a5f87&s=${this.state.title}`)
                .then(response => {
